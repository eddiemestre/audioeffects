...
*/
CResonantHPF::~CResonantHPF(void)
{


}

void CResonantHPF::calculateHPFCoeffs(float fCutoffFreq, float fQ) {
	...
	// left channel
	m_LeftHPF.m_f_a0 = fAlpha;
	m_LeftHPF.m_f_a1 = -2.0 * fAlpha;
	m_LeftHPF.m_f_a2 = fAlpha;
	m_LeftHPF.m_f_b1 = -2.0 * fGamma;
	m_LeftHPF.m_f_b2 = 2.0 * fBeta;

	// right channel
	m_RightHPF.m_f_a0 = fAlpha;
	m_RightHPF.m_f_a1 = -2.0 * fAlpha;
	m_RightHPF.m_f_a2 = fAlpha;
	m_RightHPF.m_f_b1 = -2.0 * fGamma;
	m_RightHPF.m_f_b2 = 2.0 * fBeta;
}
...
*/
bool __stdcall CResonantHPF::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CResonantHPF::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CResonantHPF::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CResonantHPF::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// (INSERT Effect)
	pOutputBuffer[0] = m_LeftHPF.doBiQuad(pInputBuffer[0]);
	...
	if(uNumInputChannels == 2 && uNumOutputChannels == 2)
		pOutputBuffer[1] = m_RightHPF.doBiQuad(pInputBuffer[1]);
...
//
bool __stdcall CResonantHPF::userInterfaceChange(int nControlIndex)
{
	// update values
	calculateHPFCoeffs(m_f_Fc_Hz, m_f_Q);
...
bool __stdcall CResonantHPF::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CResonantHPF::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CResonantHPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CResonantHPF::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CResonantHPF::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CResonantHPF::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CResonantHPF::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CResonantHPF::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CResonantHPF::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CResonantHPF::midiClock()
{
...
bool __stdcall CResonantHPF::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CResonantHPF::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CResonantHPF::showGUI(void* pInfo)
{
...
bool __stdcall CResonantHPF::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->fUserDisplayDataHiLimit = 20500.000000;
	ui0->uUserDataType = floatData;
	ui0->fInitUserIntValue = 0;
	ui0->fInitUserFloatValue = 20500.000000;
