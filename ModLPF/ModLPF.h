...
public:
	...
	// Add your code here: ----------------------------------------------------------- //
	CMassbergLPF m_ModLeft;
	CMassbergLPF m_ModRight;

	CWaveTable m_LFO;	// LFO

	void updateModules();

	float calculateDepthMod(float fLFOSample);

	// variables for depth percentage
	float m_fMinFc;
	float m_fMaxFc;
