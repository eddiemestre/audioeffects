...
void CStereoQuadFlanger::updateModDelays() {
	...
	// set up quad phase
	m_ModDelay_Left.m_uLFOPhase = 0;	// 0: normal
	m_ModDelay_Right.m_uLFOPhase = 1;	// 1: quad phase

	m_ModDelay_Left.m_fModDepth_pct = m_fModDepth_pct;
	m_ModDelay_Right.m_fModDepth_pct = m_fModDepth_pct;

	m_ModDelay_Left.m_fModFrequency_Hz = m_fModFrequency_Hz;
	m_ModDelay_Right.m_fModFrequency_Hz = m_fModFrequency_Hz;

	m_ModDelay_Left.m_fFeedback_pct = m_fFeedback_pct;
	m_ModDelay_Right.m_fFeedback_pct = m_fFeedback_pct;

	// Flanger!
	m_ModDelay_Left.m_uModType = 0;
	m_ModDelay_Right.m_uModType = 0;

	m_ModDelay_Left.m_uLFOType = m_uLFOType;
	m_ModDelay_Right.m_uLFOType = m_uLFOType;

	// cook them
	m_ModDelay_Left.updateLFO();
	m_ModDelay_Left.updateDDL();

	m_ModDelay_Right.updateLFO();
	m_ModDelay_Right.updateDDL();
}
...
bool __stdcall CStereoQuadFlanger::prepareForPlay()
{
	...
	m_ModDelay_Left.prepareForPlay();
	m_ModDelay_Right.prepareForPlay();
...
bool __stdcall CStereoQuadFlanger::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	m_ModDelay_Left.processAudioFrame(&pInputBuffer[0], &pOutputBuffer[0], 1, 1);
	...
	if (uNumInputChannels == 2 && uNumOutputChannels == 2)
		m_ModDelay_Right.processAudioFrame(&pInputBuffer[1], &pOutputBuffer[1], 1, 1);
...
{
	// just brute force update of all
	updateModDelays();
...
// **--0xDEA7--**
	...
	ui2->dPresetData[0] = 0.180000;ui2->dPresetData[1] = 0.000000;ui2->dPresetData[2] = 0.000000;ui2->dPresetData[3] = 0.000000;ui2->dPresetData[4] = 0.000000;ui2->dPresetData[5] = 0.000000;ui2->dPresetData[6] = 0.000000;ui2->dPresetData[7] = 0.000000;ui2->dPresetData[8] = 0.000000;ui2->dPresetData[9] = 0.000000;ui2->dPresetData[10] = 0.000000;ui2->dPresetData[11] = 0.000000;ui2->dPresetData[12] = 0.000000;ui2->dPresetData[13] = 0.000000;ui2->dPresetData[14] = 0.000000;ui2->dPresetData[15] = 0.000000;
